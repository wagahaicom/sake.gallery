...
define("Access_Key_ID", "AKIAJLNZVCQ7IV6LWEGQ");
define("Secret_Access_Key", "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");

// アソシエイトIDの入力
define("Associate_tag", "wagahaicom-20");

// 本のカテゴリから「東野圭吾」で検索
ItemSearch("Grocery", "日本酒");
